...
int64 nChainStartTime = 1401679922;
...
static const int CUTOFF_HEIGHT = 200;	// Height at the end of 5 weeks
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        block.nVersion = 1;
        block.nTime    = 1401679922;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 1228026;
        ...
        assert(block.hashMerkleRoot == uint256("6c1650961cdf764f94bde48feebaf482c32a2bbd0334004c33895f56a65f27e9"));
